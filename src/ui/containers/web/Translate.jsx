...
class Translate extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        if (prevProps.apistatus !== this.props.apistatus) {
            ...
            setTimeout(() => { history.push(`${process.env.PUBLIC_URL}/translations`) }, 3000);
        }
        ...
        return (
            <div className={classes.CorpusContainer}>
                ...
                <Paper style={{margin:'5%'}} elevation={2}>
                    <br/><Typography gutterBottom variant="title" component="h2" className={classes.typography}>
                    Translate
                </Typography><br/><br/>
                    ...
                    <Grid item xs={6} sm={6} lg={6} xl={6} style={{marginBottom:"5%"}}>
                        ...
                        <Button variant="contained" color="primary" className={classes.buttons} onClick={this.handleSubmit.bind(this)}>Translate</Button>
                    </Grid>
                </Paper>
                }
            </div>
